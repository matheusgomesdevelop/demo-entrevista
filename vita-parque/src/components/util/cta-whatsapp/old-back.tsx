...
export default function CtaWhatsapp({ children }) {
  ...
  function handle_post_anapro(event: any) {
    ...
    form.forEach((value, key) => {
      ...
      key === "tel" && value !== "" && validateCel(value) ? (data.tel = value) : null;
    });
    ...
    if (data.nome && data.email && data.tel) {
      ...
      const anapro_url = anaproURLWhatsapp(
        data.nome,
        data.email,
        ddd_n,
        numero,
      ...
      if (formulario) {
        ...
        strTexto.value = "Olá Gostaria de Informações sobre o empreendimento Vita Parque";
        tipo.value = "whatsapp";
        enterprise_id.value = 69;
        ...
        window.location.href = anapro_url;
      }
    }
  }
  return (
