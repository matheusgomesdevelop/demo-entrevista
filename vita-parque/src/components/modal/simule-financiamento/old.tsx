        ...
        >
          ...
          {etapa === 0 ? (
            <>
              ...
              {msgNomeErro ? (
                <p className={styles.modalSimuleFinanciamento__msgErro}>
                  {msgNomeErro}
                </p>
              ) : null}
            ...
            <>
              ...
              <label
                htmlFor="valor"
                className={styles.modalSimuleFinanciamento__labelValor}
              >
              ...
              {valorFinal ? (
                <>
                  ...
                  <div className={styles.modalSimuleFinanciamento__valorFinal}>
                    ...
                    <div
                      className={
                        styles.modalSimuleFinanciamento__valorFinal_valor
                      }
                    >
                      <span>R$</span>
                      <strong>198</strong>
                      ...
                      >
                        <img
                          src="images/icon-voltar-financiamento.svg"
                          width="16px"
                          height="16px"
                          alt=""
                        />
                ...
                <p
                  className={styles.modalSimuleFinanciamento__msgErro}
