        ...
        <section className={styles.l_lancamento}>
          <div className={styles.l_lancamento__empreendimento}>
            ...
            <div className={styles.l_lancamento__empreendimento_info}>
              <p className={styles.l_lancamento__empreendimento_info_nome}>
                LINEA VILA SÔNIA <strong>- em construção</strong>
              </p>
              <div
              ...
              >
                ...
                />
                <p>
                  Av Francisco Morato, 4228 - <strong>Vila Sônia</strong> - São
                  Paulo
                </p>
              </div>
              ...
              >
                ...
                >
                  <strong>
                    Viva com conforto e praticidade ao lado da estação de metrô
                    VILA SÔNIA!
                  </strong>{" "}
                  A região reúne muitos benefícios, além da ótima infraestrutura
                  de comércios, serviços e facilidades de acesso às principais
                  vias da cidade.{" "}
                  <a
                    href={null}
                  ...
                  <ul>
                    ...
                    <li>
                      <img
                        width="24px"
                        height="24px"
                        src="images/diferenciais/area.svg"
                        alt=""
                      />
                      <p>
                        <span>Área do terreno: </span>
                        <strong>5.250m²</strong>
                      </p>
                    </li>
                    <li>
                      <img
                    ...
                    <li>
                      ...
                      <p>
                        <strong>150m</strong>
                        <span>da Estação Vila Sônia do metrô</span>
                      </p>
                    </li>
                  </ul>
                </div>
          ...
          >
            ...
            <p className={styles.l_lancamento__empreendimento_card_parcelas}>
              A partir de <strong>R$ 210mil*</strong>
            </p>
            {/* Parcelas */}
            ...
            <div className={styles.l_lancamento__empreendimento_card_contato}>
              ...
              >
                ...
                />
                <span>
                  (011) <strong>3897-{!mostrarNumero ? "****" : "3337"}</strong>
                </span>
              </div>
            </div>
            {/* Contato */}
