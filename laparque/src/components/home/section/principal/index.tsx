      ...
      if (window.matchMedia("(min-width: 1200px)").matches) {
        ...
        window.addEventListener(
          ...
          debounce(() => {
            ...
            if (
              tamanhoScroll >= 399 &&
              tamanhoScroll <= section.offsetTop - 620
            ) {
              cardRef.current.style.transform = `translateY(${
                window.pageYOffset - 399
              }px)`;
            }
          }, 5)
        );
    ...
    <>
      ...
      <div style={{ width: "100%", position: "relative" }}>
        <section className={styles.l_lancamento}>
          <div className={styles.l_lancamento__empreendimento}>
            ...
            <div className={styles.l_lancamento__empreendimento_info}>
              <p className={styles.l_lancamento__empreendimento_info_nome}>
                LAPARQUE <strong>- lançamento</strong>
              </p>
              <div
                className={styles.l_lancamento__empreendimento_info_endereco}
              >
                <img
                  width="15px"
                  height="20px"
                ...
                />
                <p>
                  R. Marina Ciufuli Zanfelice, 176 - <strong>Lapa</strong> - São
                  Paulo
                </p>
              </div>

              <div
                className={`${styles.l_lancamento__empreendimento_info_endereco} ${styles.l_lancamento__empreendimento_info_endereco__stand}`}
              >
                <img
                  width="19px"
                  height="19px"
                  src="images/diferenciais/stand-new.svg"
                  alt=""
                />
                <p>
                  STAND DE VENDAS:
                  <strong>Av. Marquês de São Vicente, 2.477</strong>
                </p>
              </div>

              {/* Descrição */}
              <div
                className={styles.l_lancamento__empreendimento_info__descDif}
              >
                <p
                  className={styles.l_lancamento__empreendimento_info_descricao}
                >
                  <strong>O lançamento mais aguardado da LAPA chegou!</strong>{" "}
                  Produto incomparável em um dos bairros mais tradicionais da
                  capital. O fluxo de pagamento está excelente e comprar na
                  planta é o melhor negócio.{" "}
                  <a
                    href={null}
                ...
                {/* Atributos */}
                <div
                  className={styles.l_lancamento__empreendimento_info_atributos}
                >
                  <ul>
                    <li>
                      <img
                        width="27px"
                        height="27px"
                        src="images/diferenciais/varanda-new.svg"
                        alt=""
                      />
                      <p>
                        <strong>2 e 3</strong>
                    ...
                    <li>
                      <img
                        width="24px"
                        height="24px"
                        src="images/diferenciais/vaga.svg"
                        alt=""
                      />
                      <p>
                        <span>Opção de </span>
                    ...
                    <li>
                      <img
                        width="27px"
                        height="27px"
                        src="images/diferenciais/clube.svg"
                        alt=""
                      />
                      <p>
                    ...
                    <li>
                      <img
                        width="24px"
                        height="24px"
                        src="images/diferenciais/elevadores-new.svg"
                        alt=""
                      />
                      <p>
                        <strong>4</strong>
                        <span>elevadores por torre</span>
                      </p>
                    </li>
                  </ul>
                </div>
          ...
          <div
            className={styles.l_lancamento__empreendimento_card}
            ref={cardRef}
          >
            {/*  Logo */}
            <div className={styles.l_lancamento__empreendimento_card_logo}>
              <img
                src="images/secao/empreendimento/card-cta/logo-laparque.png"
                width="286px"
                height="160px"
                alt=""
              />
            ...
            <div className={styles.l_lancamento__empreendimento_card_contato}>
              <div
                className={
                  styles.l_lancamento__empreendimento_card_contato__whats
                }
                onClick={() => {
                  setCtaWhatsapp(true);
                }}
              ...
              >
                <img
                  width="34px"
                  height="34px"
                  src="images/secao/empreendimento/card-cta/icon-whats.png"
                  alt=""
                />
                <span>WhatsApp</span>
              </div>
              <div
                className={
                  styles.l_lancamento__empreendimento_card_contato__tel
                }
              ...
              >
                <img
                  width="34px"
                  height="34px"
                  src="images/secao/empreendimento/card-cta/icon-tel.svg"
                  alt=""
                />
                <span>
                  (011) <strong>2643-{!mostrarNumero ? "****" : "5008"}</strong>
                </span>
              </div>
            </div>
            {/* Contato */}
      ...
      {ctaWhatsapp ? (
        <CtaWhatsapp>
          <button
            className="close-MOP19072021"
            onClick={() => setCtaWhatsapp(false)}
          >
            <svg
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
