...
import { validationSchema, initialValues } from "@/formik/validation/lead-form";
...
export default function ModalFormConsultor({ setIsOpen }: IModalSuccess) {
  ...
  return (
    <>
      <div className={styles.formConsultor}>
        <header className={styles.formConsultor__header}>
        ...
        <div className={styles.formConsultor__container}>
          ...
          <section id="contact" className={styles.contact_container__form_section}>
            ...
            <FormWrapper className={styles.contact_container__form_wrapper}>
              <p>Para que um de nosso corretores consiga falar com você, precisaremos de alguns dados. Tudo bem?</p>
              ...
              {/* <span className={styles.contact_container__privacy}>
                Consulte nossa política de privacidade acessando <br/> este <Link href="/">link</Link>.
              </span> */}
            </FormWrapper>
          </section>
          {/* Formulário de contato*/}
